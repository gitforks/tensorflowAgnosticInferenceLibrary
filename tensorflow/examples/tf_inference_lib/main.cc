...
using tf_interface_lib::tensor_exchange_t;
...
int main(int argc, char* argv[]) {
  ...
  LOG(INFO) << resized_tensor.shape().DebugString() << "\n";
  ...
  Tensor outputTensor(tensorflow::DT_FLOAT, tensorflow::TensorShape({1,1008}));
